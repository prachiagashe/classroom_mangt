                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" readonly value="Bank Transfer"
                                       class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-500 cursor-not-allowed font-medium transition-all">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between items-center border-b border-gray-100 pb-2">
                                <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest">Assigned Subjects</h3>
                            ...
                            <div id="subjectsContainer" class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                <div class="col-span-full text-center py-6 text-sm text-gray-400 border-2 border-dashed border-gray-100 rounded-xl">
                                    Select a class to view subjects
                                </div>
                            </div>
                            
                            <!-- Single Hidden Input for Subjects JSON -->
                            <input type="hidden" name="assigned_subjects" id="assigned_subjects_input" value="{{ old('assigned_subjects') }}">
                        </div>
                    </div>
...
function toggleAndLoadClass(className) {
    ...
    if (index !== -1 && activeClass === className) {
        ...
        document.getElementById('subjectsContainer').innerHTML = `<div class="col-span-full text-center py-6 text-sm text-gray-400 border-2 border-dashed border-gray-100 rounded-xl">Select a class to view subjects</div>`;
    } else {
