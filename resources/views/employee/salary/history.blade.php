...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Salary History – {{ $employee->full_name }}</h1>
            <p class="text-gray-600 mt-1">Employee Code: #{{ $employee->employee_code }}</p>
                        ...
                        <tr>
                            <td colspan="11" class="p-8 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm mt-2">This employee doesn't have any salary records yet.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
