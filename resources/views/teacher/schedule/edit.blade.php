...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Edit Class Schedule</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Edit Class Schedule</h2>
            <p class="text-sm text-gray-600 mt-1">Update the class schedule details</p>
        </div>
        
        <form class="p-6" action="{{ route('teacher.schedule.update') }}" method="POST">
            @csrf
            @method('PUT')
