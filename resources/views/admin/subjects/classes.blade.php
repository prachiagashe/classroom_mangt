            ...
            <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                <span class="p-2 bg-indigo-100 rounded-lg text-indigo-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96 1.414l-.727 2.903a2 2 0 01-3.464 0L9.141 15.82a2 2 0 00-1.96-1.414l-2.387.477a2 2 0 00-1.022.547m0 0l-1.428 1.428a2 2 0 01-3.414-1.414l.707-2.828a2 2 0 00-.547-1.022L.543 10.141a2 2 0 010-3.414l2.828-.707a2 2 0 001.022-.547l1.428-1.428a2 2 0 013.414 0l.707 2.828a2 2 0 00.547 1.022l1.428 1.428a2 2 0 010 3.414l-2.828.707a2 2 0 00-1.022.547l-1.428 1.428z"/>
                    </svg>
                </span>
                Specialized & Competitive Programs
            </h2>
