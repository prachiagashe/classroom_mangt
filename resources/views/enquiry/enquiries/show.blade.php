            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 view-mode">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $enquiry->whatsapp ?: $enquiry->parent_mobile) }}?text={{ urlencode('Hello ' . $enquiry->first_name . ', this is ' . env('INSTITUTE_NAME', 'StudyFlow Classes') . '. How can we help you?') }}"
                           target="_blank"
