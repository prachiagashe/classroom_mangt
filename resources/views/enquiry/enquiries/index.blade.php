            ...
            <td class="text-center">
                ...
                <div id="dropdown-{{ $enquiry->id }}"
                    ...
                    <div class="py-2 text-sm text-gray-700">
                        ...
                        <button type="button" onclick="confirmDeleteEnquiry({{ $enquiry->id }}, '{{ $enquiry->status }}')"
...
<script>
function confirmDeleteEnquiry(id, status) {
    if (status.toLowerCase() === 'confirmed') {
        Swal.fire({
            icon: 'error',
            title: 'Action Denied',
            text: 'Confirmed admission enquiries cannot be deleted.',
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = `/enquiry/enquiries/${id}`; // Fixed: Removed /admin prefix
